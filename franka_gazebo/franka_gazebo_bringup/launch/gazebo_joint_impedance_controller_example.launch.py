...
def get_robot_description(context: LaunchContext, robot_id, load_gripper, franka_hand):
...
def generate_launch_description():
    ...
    robot_id_launch_argument = DeclareLaunchArgument(
            robot_id_name,
            default_value='fr3',
    ...
    robot_state_publisher = OpaqueFunction(
        ...
        args=[robot_id, load_gripper, franka_hand])
