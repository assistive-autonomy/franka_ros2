...
/**
 * The joint effort controller sends 0 torque to all joints which allows that the user can move the
 * robots freely.
 */
class GuidingController : public controller_interface::ControllerInterface {
 public:
